...
| `%arena_players_online%`         | `%PLUGININDICATOR_arena_ARENAID_players_online%`         | Get all players online                                                                                          | GLOBAL / ARENA |
...
| `%arena_timer_pretty%`                  | `%PLUGININDICATOR_arena_ARENAID_timer_pretty%`                | Get current timer of arena in a better format with :                                              | ARENA  |
...
| `%current_arena_id%`                  | `%PLUGININDICATOR_current_arena_id%`                | Get the current arena id from player (empty if no arena)                                                                                     | GLOBAL / PLAYER  |
| `%arena_current_state%`                  | `%PLUGININDICATOR_arena_current_state%`                | Get the current arena state from player (empty if no arena)                                                                                     | GLOBAL / PLAYER  |
| `%arena_current_name%`                  | `%PLUGININDICATOR_arena_current_name%`                | Get the current arena name from player (empty if no arena)                                                                                     | GLOBAL / PLAYER  |
| `%arena_current_players%`                  | `%PLUGININDICATOR_arena_current_players%`                | Get the current arena players from player (empty if no arena)                                                                                     | GLOBAL / PLAYER  |
| `%arena_current_max_players%`                  | `%PLUGININDICATOR_arena_current_max_players%`                | Get the current arena max players from player (empty if no arena)                                                                                     | GLOBAL / PLAYER  |
| `%arena_current_timer%`                  | `%PLUGININDICATOR_arena_current_timer%`                | Get the current arena timer from player (empty if no arena)                                                                                     | GLOBAL / PLAYER  |
